    ...
    <section style={{ padding: "120px 32px" }}>
      ...
      >
        ...
        <div>
          ...
          >
            Generate an HMAC-SHA256-signed sample payload - exactly what Orbital sends your
            endpoint. Verify it locally with <code>verifyWebhook</code>.
          </p>
        </div>
              ...
              <div style={{ marginTop: "16px", fontFamily: "var(--font-mono)", fontSize: "12px" }}>
                ...
                {state.data.secret && (
                  <p style={{ color: "var(--muted2)", fontSize: "11px", marginBottom: "10px" }}>
                    ...
                    <code style={{ color: "var(--accent)" }}>{state.data.secret}</code>
                  </p>
                )}
                <details open>
                  <summary
                    style={{ color: "var(--muted2)", cursor: "pointer", marginBottom: "6px" }}
                  >
                    Signed headers
                  </summary>
                  <pre
